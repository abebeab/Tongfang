...
CREATE TABLE IF NOT EXISTS solutions (
    ...
    related_products jsonb,    -- JSON array of product IDs
    downloads jsonb,           -- JSON array of R2 URLs
    created_at timestamp DEFAULT now()
);

-- 7️⃣ Downloads
-- 7️⃣ Downloads (fixed for bigint products.id)
...
-- =========================================
-- ✅ Notes:
-- 1. All images/files reference Supabase R2 URLs (public bucket).
-- 2. JSON fields allow multiple features, challenges, benefits, downloads dynamically.
-- 3. UUIDs maintain uniqueness across tables.
-- 4. Matches your folder structure completely.
-- =========================================
